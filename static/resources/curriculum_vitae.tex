...
\begin{center}
    ...
    \small \href{https://matildesilva.com/}{\uline{Personal Website}} $|$
	+351 932 295 268 $|$
...
\section{Experience}
  ...
  \resumeSubheading
	{Software Developer Engineer}{Sep. 2025 - Present}
	{\href{https://aws.amazon.com/}{Amazon Web Services}}{Dublin, Republic of Ireland}
	{}
	\resumeItemListStart
		\resumeItem{Member of AWS Lambda, working on new language launches and maintenance of existing runtimes}
	\resumeItemListEnd

  \resumeSubheading
	{Academic Researcher}{Feb. 2025 - Aug. 2025}
	{\href{https://systec.fe.up.pt/}{SYSTEC - Research Center for Systems and Technologies}}{Oporto, Portugal}
	{}
	\resumeItemListStart
		\resumeItem{Conducted experimental research on adaptive edge/fog computing architectures for IIoT, addressing privacy, scalability, and fault-tolerance limitations in current approaches}
		\resumeItem{Authored and published a \href{https://www.scitepress.org/Link.aspx?doi=10.5220/0013781300003982}{research paper} to the ICINCO 2025 conference, presenting a GDPR-compliant, event-driven architecture}
  \resumeItemListEnd
    ...
    \resumeSubheading
        ...
        {}
        \resumeItemListStart
            \resumeItem{Selected as one of 900+ candidates nationwide for a 2-month summer internship for recent graduates}
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    ...
    \textbf{Programming Languages}{: C/C++, Golang, Java, Javascript, Kotlin, Python, Rust, SQL, Swift, Typescript} \\
    \textbf{Frameworks}{: Flutter, Laravel, NodeJS, ReactJS, SvelteKit, SwiftUI} \\
    \textbf{Developer Tools}{: Android Studio, Docker, Figma, Git, Jenkins, Jira, Jupyter Notebook, Linux, Microsoft Azure, Visual Studio Code, XCode}
    }}
\end{itemize}
...
\section{Education}
  \resumeSubHeadingListStart
      \resumeSubheading
      {\href{https://sigarra.up.pt/feup/en/WEB_PAGE.INICIAL}{University of Porto}}{Sep. 2023 - Aug. 2025}
      {Master's in Informatics and Computing Engineering}{Oporto, Portugal}
      {}
	  	\resumeItemListStart
            \resumeItem{Specialization in IIoT, combined with courses on management and soft skills}
			\resumeItem{Final Grade: 16/20}
		\resumeItemListEnd
    \resumeSubheading
...
\section{Additional Work}
    \resumeSubHeadingListStart
      \resumeProjectHeading
                {\textbf{\href{https://ncgm.fe.up.pt/}{Computer Graphics and Multimedia Nucleus}}}{Sep. 2023 - Jul. 2025}
          \resumeItemListStart
