<script lang="ts">
	...
	const staticRepos = [
		{
			link: 'https://github.com/matilde-silva-21/matilde-silva-21.github.io',
			owner: 'matilde-silva-21',
			repo: 'matilde-silva-21.github.io',
			description: 'My personal website, made with SvelteKit',
			languageColor: 'rgb(255, 62, 0)',
			language: 'Svelte',
			stars: 0,
			forks: 0
		},
